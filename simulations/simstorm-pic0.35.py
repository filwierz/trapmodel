...
def get_basis(invade):
    return "java -Xmx4g -jar {0} cluster --no-x-cluins --gen 10000 --steps 100 --max-ins 10000 --min-w 0.1 --genome kb:40000,40000,40000,40000,40000 --rr cm_mb:4,4,4,4,4 --cluster each:kb:140 --ref each:kb:140 --rep 1 --silent".format(invade)
