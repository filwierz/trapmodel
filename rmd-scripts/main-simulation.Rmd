...
nohup sh -c 'python ../../scripts/simstorm-site05xMULT.py --number 300 --threads 64 --output site05xMULT- --invade ../../invade-v0808.jar --silent' &
...
tally<-read.table("/Users/filipwierzbicki/Desktop/trap_model/analysis/simulations/storm2/site05xMULT/combined/tally_site05xMULT.txt")
...
output<-read.table("/Users/filipwierzbicki/Desktop/trap_model/analysis/simulations/storm2/site05xMULT/combined/output_site05xMULT.txt")
