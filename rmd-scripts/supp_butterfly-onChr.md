...
tb<-subset(tb,select=c("chr_f","pos"))
...
tb2L<-subset(ic,chromo=="2L")
tb2L$pos<-subset(ct5,chromo=="2L")$last-tb2L$pos+1
#####
tb<-subset(ic,chromo=="2R"|chromo=="3L"|chromo=="3R"|chromo=="X")
tb<-rbind(tb,tb2L)#add 2L to the rest of the data
tb$chr_f = factor(tb$chromo, levels=c('X','2L','2R','3L','3R'))
