supp\_butterfly-cor-proTRAC
================
Filip Wierzbicki
01/20/2022

Note that currently only the output table of the missing cluins with
proTRAC (but not correlation figure) is used in the manuscript. Still
nice to see that the correlation holds also with this approach.
...
![](supp_butterfly-cor_proTRAC_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
